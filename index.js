...
const generateImage = (path) => {
    ...
    ${path}
    <br></br>
    <p style="font-size:8px;color:white">*Leve em consideração a imagem, isso e apenas para complimenta-lo pela visita ao meu pefile propagar um cadinho de humor.</p>
    </div>`
