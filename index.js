...
const generateImage = (path) => {
    ...
    const message = `<div style="display: block;width:600px;margin 0 auto">
    ${path}
    <br></br>
    <p style="font-size:8px;color:white">*Leve em consideração a imagem, isso e apenas uam forma de comprimentalo pela visita ao meu github propagar um cadinho de humor.</p>
    </div>`
